...
<body>
    ...
    <div class="content">
        ...
        <div class="content-form">
            <form method="post" action="${path }/user/updateUser.do" name="registerForm" id="registerForm">
            
            	<input type="hidden" name="userId" id="userId" value="${cur_user.userId }">
                ...
                <div id="change_margin_4">
                    <input readonly="readonly" class="inputForm" id="phoneNum" type="text" name="userPhone" placeholder="请输入手机号码" value="${cur_user.userPhone }">
                </div>
                <!-- input的value为空时弹出提醒 -->
                <p id="remind_phone"></p>
                ...
                <div id="change_margin_3">
                    <input class="content-form-signup" type="submit" value="确认修改">
                </div>
            </form>
        </div>
    </div>
